...
if [[ " ${host_list[@]} " =~ " $number " ]]; then
    ...
    rsync -av --progress ~/data/GEDI/train_subsets/train1_filtered_v1.beton /scratch/train_subsets/
    rsync -av --progress ~/data/GEDI/train_subsets/train7_filtered_v1.beton /scratch/train_subsets/
...
python run.py fit -c config/train.yaml \
        --data.init_args.train_fp $data_dir/debug0_filtered_v1.beton \
        --data.init_args.val_fp $data_dir/debug0_filtered_v1.beton \
...
python run.py fit -c config/train.yaml \
        --data.init_args.train_fp $data_dir/train1_filtered_v1.beton \
        --data.init_args.val_fp $data_dir/train7_filtered_v1.beton \
...
python run.py fit -c config/train.yaml \
        --data.init_args.train_fp $data_dir/train1_filtered_v1.beton \
        --data.init_args.val_fp $data_dir/train1_filtered_v1.beton \
        --model.init_args.out_channels 303 \
        --model.init_args.loss_fc.class_path models.losses.quantile_loss.QuantileLoss \
